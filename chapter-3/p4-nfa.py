...
p4a.node('8', label='8')
p4a.node('9', label='9')
p4a.node('10', label='10')
p4a.node('11', label='11')
p4a.node('12', label='12')
p4a.node('13', label='13')
...
p4b.node('8', label='8')
p4b.node('9', label='9')
p4b.node('10', label='10')
p4b.node('11', label='11')
p4b.node('12', label='12')
p4b.node('13', label='13')
p4b.node('14', label='14')
p4b.node('15', label='15')
...
p4c.node('8', label='8')
p4c.node('9', label='9')
p4c.node('10', label='10')
p4c.node('11', label='11')
p4c.node('end')
